...
import 'package:mapapp/themes/uber_map_theme.dart';
...
class MapaBloc extends Bloc<MapaEvent, MapaState> {
  ...
  GoogleMapController _mapa_controller;
  ...
  void initMap(GoogleMapController controller) {
    if (!state.mapaListo) {
      this._mapa_controller = controller;
      this._mapa_controller.setMapStyle(jsonEncode(uberMapTheme));
      add(OnMapaListo());
    }
  }
  ...
  void moverCamara(LatLng destino) {
    ...
    this._mapa_controller?.animateCamera(camaraUpdate);
  }
